...
export default function CarbonTwin() {
  ...
  const calculations = useMemo(() => {
    ...
    const carbonSaved = Math.max(
      0,
      Number((baseLine - totalProjected).toFixed(1)),
    );
    const costSaved = Math.max(
      0,
      Math.round(carbonSaved * 0.35 + thermostat * 4.5),
    ); // approx financial index
    ...
    <Box>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          EcoSyn compiles a virtual representation of your environmental
          footprint. Slide handles below to forecast the immediate impact of
          lifestyle shifts on your emissions and expenses.
        </Typography>
      </Box>
          ...
          >
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant="caption" color="text.secondary">
                ...
                <strong>{calculations.carFootprint} kg CO₂ / month</strong>
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant="caption" color="text.secondary">
                Calculated Footprint:{" "}
                <strong>{calculations.foodFootprint} kg CO₂ / month</strong>
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              >
                ...
                <Chip
                  label={
                    thermostat > 0 ? `+${thermostat}°C` : `${thermostat}°C`
                  }
                  size="small"
                  color="secondary"
                  sx={{ fontWeight: 700 }}
              ...
              <Typography variant="caption" color="text.secondary">
                Calculated Footprint:{" "}
                <strong>
                  {calculations.electricityFootprint} kg CO₂ / month
                </strong>
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              >
                ...
                <Chip
                  label={`${shoppingItems} items`}
                  size="small"
                  sx={{ bgcolor: "#ec4899", color: "#fff", fontWeight: 700 }}
                />
              </Box>
              <Slider
                value={shoppingItems}
              ...
              <Typography variant="caption" color="text.secondary">
                Calculated Footprint:{" "}
                <strong>{calculations.shoppingFootprint} kg CO₂ / month</strong>
              </Typography>
            </Box>
          ...
          >
            ...
            <Box>
              {calculations.totalProjected < 130 ? (
                ...
                >
                  Excellent! Your Carbon Twin has achieved{" "}
                  <strong>Sub-Industrial target levels</strong>.
                </Alert>
                ...
                >
                  Moderate footprint. Slide commuting and diet options to
                  decrease levels by another {calculations.totalProjected - 120}{" "}
                  kg.
                </Alert>
              ) : (
                <Alert
                ...
                >
                  Critical footprint height. Highly recommended to switch to
                  plant meal days or carpooling.
                </Alert>
              )}
            </Box>
                ...
                {scenarios.slice(0, 3).map((scenario) => (
                  ...
                  >
                    <CardContent sx={{ py: 1.5, "&:last-child": { pb: 1.5 } }}>
                      ...
                      <Typography variant="caption" color="text.secondary">
                        Saves {scenario.calculations?.carbonSaved || 0} kg CO2
                        and ${scenario.calculations?.costSaved || 0}/mo
                      </Typography>
                    </CardContent>
                  </Card>
                ))}
